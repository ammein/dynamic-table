...
}</code></pre>You can refer here for more info : <a href="https://datatables.net/examples/ajax/" target="_blank">DataTables JS Ajax Data Source</a><br>NOTE : You must use double quote string on your field name to make it work, for instance : <code style=\"font-family: monospace;background-color: #EEE;font: 300 12px monospace; padding:5px;\">\"ajax\" : "<ajaxUrl>"</code>`
            },
            {
                name: "data",
                label: "Custom Data",

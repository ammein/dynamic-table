module.exports = {
    ...
    construct : function(self,options){
        ...
        options.arrangeFields = self.table.tableSchemasGroup;

        self.allBrowserCalls = function(){
            // For get options on editor modal & Extend it
            self.apos.push.browserCall('always', 'Object.assign(apos.create("dynamic-table-widgets-editor"), ?)' , { table : self.table });
        }

...
var dt = require('datatables.net-dt')(window, _jquery["default"]);

_jquery["default"].fn.DataTable = dt;
...
apos.utils.widgetPlayers['dynamic-table'] = function (el, data, options) {
  ...
  utils.getResult = function (query, callback) {
    _jquery["default"].get('/modules/dynamic-table/get-fields', query, function (result) {
  ...
  apos.utils.onReady(function () {
    ...
    utils.getResult({
      ...
      (0, _jquery["default"])(table).DataTable(DataTableOptions || DataTableAjaxOptions);
    });
  });
...
},{"datatables.net-dt":1,"jquery":3}]},{},[4]);

apos.define('dynamic-table-widgets-editor', {
    ...
    construct : function(self,options){
        ...
        self.initTable = function(){
            ...
            convertData.val(JSON.stringify("{" + "\"data\" : " + JSON.stringify(self.rowData) + "," + "\"columns\" : " + JSON.stringify(self.columnData) + "}" , undefined, 2));
        }
        ...
        self.beforeShow = function(callback){
            return superBeforeShow(function(err){
                ...
                self.$ajaxOptions.on("change" , function(e){
                    var options = JSON.parse(e.currentTarget.querySelector("textarea").value);

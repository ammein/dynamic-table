            ...
            self.$tableHTML.each(function (i, val) {
                ...
                if (val.offsetParent !== null) {
                    ...
                    if (apos.assets.options.lean){
                        ...
                        if (self.EditorDataTableOptions.columns && self.EditorDataTableOptions.aoColumns) {
                        ...
                        try{
                            ...
                            // Initialize
                            new simpleDatatables.DataTable(val.querySelector("#dynamicTable"), {
                                data: obj ? obj : self.EditorDataTableOptions.data
                            });
                        }catch(e){
                            // Empty the table to reinitialization

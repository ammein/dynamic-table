...
var JS = [
    { src: 'src/js/dynamic-table-widgets/lean/', name: 'lean', dest: 'collections/modules/dynamic-table-widgets/public/js' },
    { src: 'src/js/dynamic-table-widgets/always/', name: 'always', dest: 'collections/modules/dynamic-table-widgets/public/js' },
